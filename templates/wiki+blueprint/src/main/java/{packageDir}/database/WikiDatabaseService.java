...
package {{ metadata.package }}.database;
...
public interface WikiDatabaseService {
  ...
  @GenIgnore
  static {{ metadata.package }}.database.reactivex.WikiDatabaseService createProxy(Vertx vertx, String address) {
    return new {{ metadata.package }}.database.reactivex.WikiDatabaseService(new WikiDatabaseServiceVertxEBProxy(vertx, address));
  }
