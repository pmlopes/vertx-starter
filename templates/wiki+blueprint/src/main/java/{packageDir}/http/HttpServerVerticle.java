...
import {{ metadata.package }}.database.reactivex.WikiDatabaseService;
...
public class HttpServerVerticle extends AbstractVerticle {
  ...
  public void start(Future<Void> startFuture) throws Exception {
    ...
    dbService = {{ metadata.package }}.database.WikiDatabaseService.createProxy(vertx.getDelegate(), wikiDbQueue);
